...
def submit_final(
    ...
    # Validasi wajib diisi: HANYA jika bukan auto-submit / waktu belum habis.
    # Jika waktu habis (auto-submit), lewati validasi agar jawaban yang terisi seadanya tetap otomatis terkirim.
    if not is_time_expired and not submission.is_auto_submitted:
