...
const TentangPage = () => {
  ...
  return (
    <div className="hp-root">
      ...
      {/* ── HERO TENTANG ── */}
      <section className="tp-hero flex justify-center text-center py-16">
        <div className="tp-hero-inner flex flex-col items-center max-w-3xl mx-auto">
          <h1 className="tp-hero-title">
            Merancang Formulir Kini Semakin<br />
            Mudah, Cepat, dan Efisien
          </h1>
          <p className="tp-hero-sub">
            form4x dirancang untuk menyederhanakan proses pembuatan formulir
            kompleks. Dengan antarmuka yang bersih dan alat logika yang kuat,
            kumpulkan data yang Anda butuhkan tanpa kerumitan teknis.
          </p>
          <Link to="/auth" id="btn-tentang-mulai" className="tp-btn-cta inline-block">
            Mulai Membuat Form
          </Link>
        </div>
      </section>
      ...
      <footer className="tp-footer">
        <div className="tp-footer-inner">
          ...
          <p className="tp-footer-copy">© 2026 formMaker. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
